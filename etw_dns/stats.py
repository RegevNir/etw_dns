...
class StatsTracker:
    ...
    def print_stats(self) -> None:
        ...
        interval = current_time - self._last_report_time
    ...
    def print_final_stats(self) -> None:
        ...
        print(f"Elapsed time:     {stats['elapsed_seconds']:.1f} seconds", file=sys.stderr)
        print(f"Average rate:     {stats['events_per_second']:.1f} events/sec", file=sys.stderr)
        
        if stats['events_dropped'] > 0:
            drop_rate = (stats['events_dropped'] / stats['events_captured'] * 100) if stats['events_captured'] > 0 else 0
